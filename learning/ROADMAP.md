...
**Optional extensions (not scheduled yet):** SIMD (`float`×4), FFT spectrum meter, wavetable interpolation, BLEP anti-aliasing for saw/square.
...
- [ ] **Lab 03 — AudioCore + miniaudio** ← you are here
- [ ] Lab 04 — `std::thread` + ZMQ + lock-free queue
- [ ] Lab 05 — Biquad LPF
- [ ] Lab 06 — State-variable filter
- [ ] Lab 07 — Delay + soft saturation
- [ ] Lab 08 — Polyphony

**Next step:** [lab03/README.md](lab03/README.md)
